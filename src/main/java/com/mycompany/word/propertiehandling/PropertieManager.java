...
//                return zuordnung;
                ...
                LOG.debug("falsche menue propertie " + e);
            }
        } catch (BeansException e) {
            LOG.debug("falsche zuordnung propertie " + e);
            zuordnung = (Zuordnung) ctx.getBean("zuordnungImpl");
        }
        return zuordnung;
    }
    ...
    public String[] getMenufields() {
        try {
            ...
            if (props.containsKey("menuefelder")) {
            ...
            LOG.debug("menuefelder konnten nicht gelesen werden");
            return null;
        }
    }
